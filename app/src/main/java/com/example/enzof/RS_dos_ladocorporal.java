...
public class RS_dos_ladocorporal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electrodos);
        ...
        BContinuar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((opcionesL != null && opcionesL.length > 0 && SpinnerL.getSelectedItemPosition() == 0)) {
                    Toast.makeText(RS_dos_ladocorporal.this, "Seleccione un lado", Toast.LENGTH_SHORT).show();
                } else {
                    Intent intent = new Intent(RS_dos_ladocorporal.this, RS_tres_ejercicio.class);
    ...
    // 5. CAMBIO DE PANTALLA ELECTRODOS
