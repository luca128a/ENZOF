...
import com.example.enzof.databinding.ActivityCunoMusculoBinding;

public class C_uno_musculo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cuno_musculo);
        ...
        BContinuar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ((opcionesM != null && opcionesM.length > 0 && SpinnerM.getSelectedItemPosition() == 0)) {
                    Toast.makeText(C_uno_musculo.this, "Seleccione una zona corporal", Toast.LENGTH_SHORT).show();
                } else {
                    Intent intent = new Intent(C_uno_musculo.this, C_dos_ladocorporal.class);
    ...
    private void cambiarpantalla() {
        ...
        if (musculoSeleccionado == null) {
            Toast.makeText(C_uno_musculo.this, "Seleccione músculo", Toast.LENGTH_SHORT).show();
        } else if ((opcionesM != null && opcionesM.length > 0 && SpinnerM.getSelectedItemPosition() == 0)) {
            Toast.makeText(C_uno_musculo.this, "Seleccione acerca de que quiere saber más", Toast.LENGTH_SHORT).show();
        } else {
