...
public class C_tres_ejercicio extends AppCompatActivity {
    //1. DECLARACIONES
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ctres_ejercicio);
        ...
        BContinuar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((opcionesE != null && opcionesE.length > 0 && SpinnerE.getSelectedItemPosition() == 0)) {
                    Toast.makeText(C_tres_ejercicio.this, "Seleccione un tipo de ejercicio", Toast.LENGTH_SHORT).show();
                } else {
                    if ((tipoejercicio.equals("1. Cíclico con carga") || tipoejercicio.equals("3. Estático")) && (pesoSeleccionado == 0)) {
                        Toast.makeText(C_tres_ejercicio.this, "Seleccione el peso a utilizar", Toast.LENGTH_SHORT).show();
                    } else {
                        Intent intent = new Intent(C_tres_ejercicio.this, Calibracion.class);
